    ...
    <section id="platforms" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="flex gap-6 animate-scroll overflow-hidden">
            {[...platforms, ...platforms].map((platform, index) => (
              <div
                ...
                className="flex-shrink-0 px-8 py-4 rounded-xl bg-card border border-border hover:border-primary/50 transition-all duration-300 hover:scale-105"
              >
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center gap-4 px-8 py-4 rounded-2xl bg-card/50 border border-border">
